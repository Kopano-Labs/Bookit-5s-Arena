...
const WORLD_CUP_TEAMS = [
  ...
  { name: 'USA', player: 'Christian Pulisic', logo: '/images/tournment/worldcup-logos/usa-team.jpg', profile: '/images/tournment/worldcup-player-profiles/christian-pulisic.png' },
  { name: 'Mexico', player: 'Santiago Giménez', logo: '/images/tournment/worldcup-logos/mexico-team.jpg', profile: '/images/tournment/worldcup-player-profiles/santiago-gimenez.jpg' },
  { name: 'Netherlands', player: 'Virgil van Dijk', logo: '/images/tournment/worldcup-logos/netherlands-team.jpg', profile: '/images/tournment/worldcup-player-profiles/virgil-van-dijk.png' },
  { name: 'Nigeria', player: 'Victor Osimhen', logo: '/images/tournment/worldcup-logos/nigeria-team.jpg', profile: '/images/tournment/worldcup-player-profiles/victor-osimhen.png' },
  { name: 'Senegal', player: 'Sadio Mané', logo: '/images/tournment/worldcup-logos/senegal-team.jpg', profile: '/images/tournment/worldcup-player-profiles/sadio-mane.png' },
  { name: 'Colombia', player: 'Luis Díaz', logo: '/images/tournment/worldcup-logos/colombia-team.jpg', profile: '/images/tournment/worldcup-player-profiles/luis-diaz.png' },
  { name: 'Croatia', player: 'Luka Modrić', logo: '/images/tournment/worldcup-logos/croatia-team.jpg', profile: '/images/tournment/worldcup-player-profiles/luka-modric.png' },
  { name: 'Belgium', player: 'Kevin De Bruyne', logo: '/images/tournment/worldcup-logos/belgium-team.jpg', profile: '/images/tournment/worldcup-player-profiles/kevin-de-bruyne.png' },
  { name: 'Uruguay', player: 'Federico Valverde', logo: '/images/tournment/worldcup-logos/uruguay-team.jpg', profile: '/images/tournment/worldcup-player-profiles/federico-valverde.png' },
