                      ...
                      <thead>
                        <tr className="border-b border-gray-800 text-left">
                          ...
                          <th className="px-5 py-4 text-xs font-bold text-gray-500 uppercase tracking-widest">
                            Payment{' '}
                            <InfoTooltip text="Payment status of the booking. 'Pay at Venue' means the player chose to pay on arrival. Use 'Mark Paid' once payment is received." size={12} />
                          </th>
                          <th className="px-5 py-4 text-xs font-bold text-gray-500 uppercase tracking-widest">
                            Update{' '}
                            <InfoTooltip text="Change the booking status. Confirming a Stripe booking will automatically mark it as paid." size={12} />
                          </th>
                        </tr>
                      </thead>
                      <tbody>
