...
import {
  FaTrophy, FaHandshake, FaBan, FaUserPlus,
  FaFutbol, FaShieldAlt, FaTools, FaFileContract,
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h1
              ...
              style={{ fontSize: 'clamp(2rem, 6vw, 4rem)', fontFamily: 'Impact, Arial Black, sans-serif' }}
            >
              RULES OF THE <span className="text-green-400">GAME</span>
            </h1>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Everything you need to know before stepping on the pitch. Click on any chapter below to learn more!
            </p>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <FaChevronDown className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500" size={12} />
            </div>
          </motion.div>
        </div>
      </section>
            ...
            return (
              ...
              >
                <motion.button
                  ...
                  style={{
                    borderColor: isActive ? chapter.color : 'rgba(55,65,81,0.5)',
                    background: isActive
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        ...
                        >
                          <FaChevronDown size={12} style={{ color: chapter.color }} />
                        </motion.span>
                      </div>
                      <p className="text-gray-400 text-xs mt-1 line-clamp-2">{chapter.desc}</p>
                    </div>
                  </div>
                </motion.button>
                  ...
                  {isActive && (
                    ...
                    >
                      <div className="px-5 py-4 space-y-2">
                        {chapter.content.map((line, j) => (
                          <motion.p
                            key={j}
                            className={`text-sm leading-relaxed ${
                              line.startsWith('**') ? 'text-red-400 font-black text-xs uppercase tracking-wider bg-red-900/20 p-3 rounded-lg border border-red-800/30' :
                          ...
                          <div className="flex gap-3 pt-3">
                            {chapter.links.map((link) => (
                              <a
                                ...
                                style={{ color: chapter.color, borderColor: `${chapter.color}40` }}
                              >
                                {link.label}
                              </a>
                            ))}
              ...
              >
                <Link href={cta.href}>
                  <motion.div
                    ...
                    style={{ borderColor: `${cta.color}30`, background: `${cta.color}08` }}
                    whileHover={{
                      scale: 1.03,
                    ...
                    whileTap={{ scale: 0.97 }}
                  >
                    <Icon size={28} style={{ color: cta.color }} className="mx-auto mb-3" />
                    <h3 className="font-bold text-white text-sm uppercase tracking-wider mb-2">{cta.title}</h3>
                    <p className="text-gray-400 text-xs mb-3">{cta.desc}</p>
                    <span className="inline-flex items-center gap-1 text-xs font-bold uppercase tracking-wider" style={{ color: cta.color }}>
