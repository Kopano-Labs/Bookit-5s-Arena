...
import { FaBriefcase, FaMapMarkerAlt, FaClock, FaMoneyBillWave, FaArrowRight } from 'react-icons/fa';
...
const JOBS = [
  {
    ...
    description: 'We are looking for experienced and fair referees to officiate our Saturday and Sunday social leagues. Must have a strong understanding of 5-a-side rules and excellent communication skills.',
    urgent: true,
  },
  {
    id: 2,
    ...
    location: 'Milnerton, CT',
    salary: 'R50/hr + Tips',
    description: 'Join the 5s Arena clubhouse team! Fast-paced environment serving our players post-match drinks and snacks. Previous bar experience preferred.',
    urgent: false,
  },
  {
    id: 3,
    ...
    salary: 'Negotiable',
    description: 'Love football and have an eye for a great shot? We need someone to film match highlights, conduct post-match interviews, and create high-energy social media content for the 5s Arena World Cup.',
    urgent: false,
  },
];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto">
            Find active job openings, volunteer opportunities, and freelance gigs at 5s Arena. Help us build the ultimate football experience.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 relative z-10">
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl font-black uppercase tracking-widest text-white mb-4" style={{ fontFamily: 'Impact, Arial Black, sans-serif' }}>
                    {job.title}
                  </h2>
                  
                  <div className="flex flex-wrap items-center gap-4 text-xs font-bold text-gray-500 uppercase tracking-widest mb-6">
                    <span className="flex items-center gap-1.5"><FaMapMarkerAlt className="text-gray-600" /> {job.location}</span>
                    <span className="flex items-center gap-1.5"><FaMoneyBillWave className="text-gray-600" /> {job.salary}</span>
                  </div>
                ...
                <div className="flex-shrink-0 flex flex-col justify-end">
                  <a 
                    href="mailto:jobs@5sarena.co.za?subject=Application for ${job.title}"
                  ...
                  >
                    Apply Now <FaArrowRight size={10} className="group-hover:translate-x-1 transition-transform" />
                  </a>
                </div>
              </div>
            </motion.div>
        ...
        <div className="mt-16 text-center border-t border-gray-800 pt-10">
          ...
          <p className="text-gray-500 text-sm mb-6 max-w-md mx-auto">
            We're always looking for passionate people to join the 5s Arena family. Drop us your CV and we'll keep it on file.
          </p>
          <a href="mailto:jobs@5sarena.co.za?subject=General Application" className="text-green-400 font-bold uppercase tracking-widest text-sm hover:text-green-300">
