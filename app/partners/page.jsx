...
const SPONSORS = [
  {
    ...
    desc: "Home of the 5s Arena World Cup.",
    link: "https://hellenicfc.co.za",
  },
  {
    id: 2,
    name: "Robyn Awesome Sports Gear",
    tier: "Gold Affiliate",
    desc: "Official kit supplier. Use code 5SARENA for 10% off.",
    link: "https://store.fivesarena.com",
  },
  {
    id: 3,
    name: "Cape Town Energy Drinks",
    tier: "Silver Sponsor",
    desc: "Fueling our athletes during late-night fixtures.",
    link: "#",
  },
];
...
const GUEST_POSTS = [
  {
    id: 1,
    title: "How to Build a Winning 5-a-side Team",
    author: "Coach Mike",
    date: "April 2026",
    link: "/blog/winning-team",
  },
  {
    id: 2,
    title: "Nutrition for Short Format Football",
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Discover the brands and organizations that make 5s Arena possible.
          ...
          {SPONSORS.map((sponsor, i) => (
            <motion.a
              ...
              className={`bg-gray-900 border rounded-2xl p-8 text-center flex flex-col items-center justify-between group overflow-hidden relative cursor-pointer ${
                sponsor.tier.includes("Platinum")
                  ? "border-blue-500"
                  : sponsor.tier.includes("Gold")
                    ? "border-yellow-500"
                    : "border-gray-500"
              }`}
            >
              <div
                className={`absolute top-0 right-0 p-2 text-[10px] font-black uppercase tracking-widest bg-gray-800 rounded-bl-xl ${
                  sponsor.tier.includes("Platinum")
                    ? "text-blue-400 border-b border-l border-blue-500"
                    : sponsor.tier.includes("Gold")
                      ? "text-yellow-400 border-b border-l border-yellow-500"
                      : "text-gray-400 border-b border-l border-gray-500"
                }`}
              >
                {sponsor.tier}
              </div>
              ...
              <div>
                <h3
                  className="text-xl font-bold uppercase tracking-widest text-white mb-3"
                  style={{ fontFamily: "Impact, Arial Black, sans-serif" }}
                >
                  {sponsor.name}
                </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {GUEST_POSTS.map((post, i) => (
            ...
            >
              ...
              <button
                disabled
                className="text-sm text-gray-500 flex items-center gap-2 border border-gray-700 rounded-lg px-4 py-2 cursor-not-allowed"
              >
        ...
        <p className="text-center text-xs text-gray-500 uppercase tracking-widest mt-16 border-t border-gray-800 pt-8">
          All affiliate links are marked and we may earn a small commission on
