  ...
  return (
    <section className="relative overflow-hidden py-16 px-4">
      ...
      <div className="absolute inset-0 opacity-10" style={{
        backgroundImage: 'radial-gradient(circle at 20% 50%, rgba(34,197,94,0.3) 0%, transparent 50%), radial-gradient(circle at 80% 50%, rgba(34,197,94,0.2) 0%, transparent 50%)',
      }} />
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        <motion.div
          ...
          style={{ background: 'linear-gradient(135deg, #15803d 0%, #22c55e 100%)', boxShadow: '0 0 40px rgba(34,197,94,0.3)' }}
        >
        ...
        <motion.h2
          ...
          style={{ fontFamily: 'Impact, Arial Black, sans-serif', textShadow: '0 4px 20px rgba(0,0,0,0.5)' }}
        ...
        >
          Keep Up With Your{' '}
          <span className="text-green-400" style={{ textShadow: '0 0 30px rgba(34,197,94,0.4)' }}>
            Favourites
          </span>
        </motion.h2>
        ...
        >
          Live scores, match updates, referee decisions &amp; highlights — all the world's biggest leagues in one place. Never miss a goal.
        </motion.p>
        ...
        >
          <Link href="/fixtures">
            <motion.div
              ...
              style={{ background: 'linear-gradient(135deg, #15803d 0%, #22c55e 100%)', boxShadow: '0 0 30px rgba(34,197,94,0.3)' }}
        ...
        >
          {['Champions League', 'Premier League', 'La Liga', 'Serie A', 'Bundesliga', 'PSL'].map((league) => (
            <span
              key={league}
