...
export default function NewsletterPopup() {
  ...
  useEffect(() => {
    // Show popup after 20 seconds, but only once per session
    const dismissed = sessionStorage.getItem('5s_newsletter_dismissed');
    const subscribed = localStorage.getItem('5s_newsletter_subscribed');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus('success');
      localStorage.setItem('5s_newsletter_subscribed', 'true');
  ...
  const dismiss = () => {
    setShow(false);
    sessionStorage.setItem('5s_newsletter_dismissed', 'true');
  };
            ...
            {status === 'success' ? (
              ...
              >
                ...
                <p className="text-gray-400 text-sm">
                  Welcome to the 5s Arena family. You&apos;ll receive match updates, exclusive deals, and tournament news.
                </p>
              </motion.div>
            ) : (
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-400 text-sm">
                    Get tournament updates, fixture alerts, exclusive deals, and behind-the-scenes content straight to your inbox.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  <div className="relative">
                    <input
                      ...
                      required
                    />
                    <FaEnvelope className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-600" size={12} />
                  </div>
                  <motion.button
                    type="submit"
