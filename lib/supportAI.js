...
const KNOWLEDGE_BASE = {
  booking: {
    ...
    answer: 'To book a court, head to the home page, choose your preferred court, select a date and time, then click "Book Now". You can book courts from 10:00 to 21:00 daily. Courts start at R400/hour.',
  },
  cancel: {
  ...
  hours: {
    ...
    answer: 'Our courts are available from 10:00 to 21:00 daily (last booking starts at 21:00). The venue, bar, and restaurant may have extended hours. Check individual court pages for specific availability.',
  },
  amenities: {
  ...
  payment: {
    ...
    answer: 'Currently, you can reserve courts online and pay at the venue (cash or card). Online payment integration (Stripe) is coming soon. For events and larger bookings, we also accept EFT — contact us for bank details.',
  },
  contact: {
