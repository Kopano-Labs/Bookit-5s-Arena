...
// Embed logo as base64 so it shows in email clients even on localhost
const getLogoDataUri = () => {
  try {
    ...
    return null; // Fall back to text badge
  }
};
                ...
                <table cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="vertical-align: middle;">
                      ${logoDataUri
                        ? `<img src="${logoDataUri}" alt="5S Arena" width="52" height="52" style="width:52px;height:52px;border-radius:50%;border:2px solid #22c55e;object-fit:cover;display:block;" />`
                        : `<div style="background: linear-gradient(135deg, #15803d, #22c55e); width: 48px; height: 48px; border-radius: 50%; text-align: center; line-height: 48px;"><span style="color: #fff; font-size: 20px; font-weight: 900; font-family: Impact, Arial Black, sans-serif;">5S</span></div>`
                      }
                    </td>
