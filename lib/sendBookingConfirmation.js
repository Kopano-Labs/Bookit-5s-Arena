...
export async function sendBookingConfirmation({
  ...
  const logoHtml = (siteUrl && siteUrl.startsWith('https://') && !siteUrl.includes('localhost'))
    ? `<img src="${siteUrl}/images/logo.jpg" alt="5S Arena" width="52" height="52" style="width:52px;height:52px;border-radius:50%;border:2px solid #22c55e;object-fit:cover;display:block;" />`
